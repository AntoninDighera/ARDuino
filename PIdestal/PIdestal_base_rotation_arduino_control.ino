/* 
This is the code for the pidestal, it uses the adafruit motorshield v2.3.
*/
...
const int MOTOR_SPEED = 7; //int value used to define motor speed, small impulses are aroun 5/10, max speed is 225 *personal note, 100 is extremely fast. 
